...
final clientiFiltrati = clientiData
    ...
    .toList();
                      ...
                      double? contMatricola = form.control('contMatricola').value;
                      ...
                      final nuovoIntervento = Intervento(
                        ...
                        rifMatricolaCliente: form.control('rifMatricolaCliente').value,
                      ...
                      return matricoleData.when(
                        data: (targaCollection) {
                          ...
                          return ReactiveDropdownSearch<dynamic,
                            ...
                            filterFn: (item, filter) => '${item.rifMatricolaCliente ?? ''} - ${item.descrizione}'
                                .toString()
                                .toLowerCase()
                            ...
                            onBeforeChange: (prevItem, nextItem) {
                              form.control('rifMatricolaCliente').value = nextItem?.rifMatricolaCliente;
                              form.control('desCli').value = nextItem?.desCli;
                              form.control('telaio').value = nextItem?.telaio;
                              form.control('codice').value =
                                  nextItem?.codice;
