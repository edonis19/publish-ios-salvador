  ...
  return DataGridRowAdapter(
    cells: row.getCells().map<Widget>((dataGridCell) {
      if (dataGridCell.columnName == 'button') {
        ...
        // Mostra una cella vuota nella colonna 'delete' se lo status non è 'NO SYNC'
        return SizedBox(); // Oppure Text(''), Container(), o un widget vuoto a seconda delle tue esigenze
      } else {
